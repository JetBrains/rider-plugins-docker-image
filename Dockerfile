...
RUN apt-get update && DEBIAN_FRONTEND=noninteractive apt-get -y install mono-complete=$RIDER_BUILD_MONO_VERSION mono-dbg=$RIDER_BUILD_MONO_VERSION mono-runtime-dbg=$RIDER_BUILD_MONO_VERSION \
